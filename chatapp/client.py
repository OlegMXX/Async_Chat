...
from common.jim_variables import EXIT, ACTION, MESSAGE, TIME, ACCOUNT_NAME, SENDER, MESSAGE_TEXT, DESTINATION, \
    ADD_CONTACT, GET_CONTACTS, DEL_CONTACT, CHAT_USER, TARGET_USER, RESPONSE, ERROR, PRESENCE
