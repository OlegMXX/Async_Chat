...
from common.jim_variables import DESTINATION, SENDER, ACTION, PRESENCE, TIME, EXIT, RESPONSE, ERROR, CHAT_USER, \
    TARGET_USER, ACCOUNT_NAME, GET_CONTACTS, ADD_CONTACT, DEL_CONTACT, MESSAGE, MESSAGE_TEXT, ALERT
